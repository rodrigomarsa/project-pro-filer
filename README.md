...
Trabalhei com uma aplicação com uma interface de linha de comando (CLI) que recebe como entrada um caminho (diretório ou arquivo) e gera um relatório com informações sobre o caminho informado.
...
Na 1 primeira chamada, a função imprime a quantidade de arquivos e diretórios encontrados, além de listas com os 5 primeiros arquivos e 5 primeiros diretórios.
